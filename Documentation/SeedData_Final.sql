-- IntelliFit Database Seed Data - CORRECT SCHEMA (snake_case tables, PascalCase columns)
-- ==========================================
...
VALUES
    -- Plan 1 - Day 1
    (1, 1, 1, 1, 3, 10, 90, 'Focus on form', NOW ()),
    (
        1,
        2,
        1,
    ...
    -- Plan 1 - Day 2
    (1, 3, 2, 1, 3, 5, 180, 'Use proper form', NOW ()),
    (
        1,
        4,
        2,
    ...
    -- Plan 1 - Day 4
    (1, 10, 4, 1, 3, 10, 75, 'Pull to chest', NOW ()),
    (
        1,
        2,
        4,
    ...
    (1, 6, 4, 3, 3, 8, 90, 'Strict form', NOW ());

-- ==========================================
-- 8. EQUIPMENT CATEGORIES
-- ==========================================
INSERT INTO
    equipment_categories ("CategoryName", "Description")
VALUES
...
VALUES
    (1, 'Treadmill', 0, 0, true, NOW (), NOW ()),
    (1, 'Stationary Bike', 0, 0, true, NOW (), NOW ()),
    (2, 'Squat Rack', 0, 0, true, NOW (), NOW ()),
    (
        2,
        'Bench Press Station',
        0,
    ...
    (3, 'Dumbbell Set', 0, 0, true, NOW (), NOW ());
